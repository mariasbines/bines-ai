...
/**
 * LinkedIn glyph as inline SVG, in LinkedIn brand blue (#0A66C2).
 * Trademark colour preserved — it's a credentials link to a real
 * external profile, not site chrome.
 */
